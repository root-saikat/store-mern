...
const Disposables = () => {
    ...
    const getAllProductByCategory = async (categoryId) => {
        try {
            const response = await fetch(`${host}/api/product/get-cat-product/654678d77802749af076b10e`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'auth-token': token,
        ...
        <>
                ...
                <div className="container">
                    <nav aria-label="breadcrumb">
                        <ol className="breadcrumb">
                            ...
                            <li className="breadcrumb-item active" aria-current="page">Disposables</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div className="p-bnr">
                <div className="pr-banner">
                    <img src="/assets/products/disposal_vape.jpg" alt="" width="100%" />
                </div>
            </div>
