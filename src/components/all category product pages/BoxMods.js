...
const BoxMods = () => {
    ...
    const getAllProductByCategory = async (categoryId) => {
        try {
            const response = await fetch(`${host}/api/product/get-cat-product/6546791a7802749af076b113`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'auth-token': token,
        ...
        <>
                ...
                <div className="container">
                    <nav aria-label="breadcrumb">
                        <ol className="breadcrumb">
                            ...
                            <li className="breadcrumb-item active" aria-current="page">Box-Mods</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div className="p-bnr">
                <div className="pr-banner">
                    <img src="/assets/products/box-mods.jpg" alt="" width="100%" />
                </div>
            </div>
