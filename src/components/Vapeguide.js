      ...
      <div className="breadcrumb-links mt-5">
            <div className="container">
                <nav aria-label="breadcrumb">
                    <ol className="breadcrumb mt-3">
                        ...
                        <li className="breadcrumb-item active" aria-current="page">Vape Guide</li>
                    </ol>
                </nav>
            </div>
        </div>
        <div className="p-bnr">
            <div className="pr-banner">
                <img src="../assets/products/vape-guide.jpg" alt="" width="100%"/>
            </div>
        </div>
        <section className="vape-guide-acordian mt-5 mb-5">
            <div className="container">
